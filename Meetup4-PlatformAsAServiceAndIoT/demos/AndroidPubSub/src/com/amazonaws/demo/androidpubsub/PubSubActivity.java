...
public class PubSubActivity extends Activity {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT_PREFIX = "XXXXXXXXXXXXXXX";

    // Cognito pool ID. For this app, pool needs to be unauthenticated pool with
    // AWS IoT permissions.
    private static final String COGNITO_POOL_ID = "eu-west-1:XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX";

    // Name of the AWS IoT policy to attach to a newly created certificate
    private static final String AWS_IOT_POLICY_NAME = "PubSubToAnyTopic";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnScanBarcode.setOnClickListener(publishBarcode);

        btnScanQRCode = (Button) findViewById(R.id.btnScanQRCode);
        btnScanQRCode.setOnClickListener(publishQRCode);
    ...
    View.OnClickListener publishBarcode = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    View.OnClickListener publishQRCode = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent intent = new Intent("com.google.zxing.client.android.SCAN");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        if (requestCode == 0) {
            if (resultCode == RESULT_OK) {
                ...
                String msg = "Content:" + contents + " Format:" + format;
...
// Handle successful scan
                ...
                if(msg.contains("Content:") && msg.contains("Format:")) {
                    msg = msg.replace("Content:", "");
                    msg = msg.replaceAll("Format:","/");
